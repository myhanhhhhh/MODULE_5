...
public class StudentRestController_getListStudent {
    ...
    public void getListStudent_6() throws Exception {
        ...
        this.mockMvc.perform(
                ...
                .andExpect(jsonPath("content[0].name").value("Silversmid"))
                .andExpect(jsonPath("content[0].dateOfBirth").value("1998-12-06"))
                .andExpect(jsonPath("content[0].classStudent.id").value(4))
                .andExpect(jsonPath("content[9].name").value("Canner"))
                .andExpect(jsonPath("content[9].dateOfBirth").value("1999-07-30"))
                .andExpect(jsonPath("content[9].classStudent.id").value(5));
    }
